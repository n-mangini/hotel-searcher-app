...
import com.ua.hotel_searcher_app.data.PreferencesKeys
import com.ua.hotel_searcher_app.data.getFromDataStore
...
class ProfileViewModel @Inject constructor(
    ...
    fun saveToDataStore(username: String) {
        viewModelScope.launch {
            com.ua.hotel_searcher_app.data.saveToDataStore(
                context,
                username,
